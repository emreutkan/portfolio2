    ...
    <section className={styles.heroSection} id="home">
        ...
        <div className={styles.heroVisual}>
          <div className={styles.profileContainer}>
            ...
            <div className={styles.floatingElements}>
              <div className={styles.floatingElement} data-type="react">⚛️</div>
              <div className={styles.floatingElement} data-type="typescript">📘</div>
              <div className={styles.floatingElement} data-type="nodejs">🟢</div>
              <div className={styles.floatingElement} data-type="database">🗄️</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.techCarousel}>
        <div className={styles.carouselTrack}>
          ...
          {technologies.map((tech, index) => (
            <div key={`${tech.name}-duplicate-${index}`} className={styles.techItem}>
              <img 
                src={tech.logo} 
                alt={tech.name}
                className={styles.techLogo}
