...
const Freshdeal: React.FC = () => {
  const { sectionRef, initialTitleRef, initialPhoneRef, contentWrapperRef } =
    useScrollTransform();
  ...
  return (
    <section
      ...
      <div className={styles.container}>
        ...
        <div ref={initialTitleRef} className={styles.initialTitle}>
          <h1>FRESHDEAL</h1>
        </div>

        {/* Initial large phone */}
        <div ref={initialPhoneRef} className={styles.initialPhone}>
